...
public class txtIO : MonoBehaviour
{
    ...
    public void WriteToFile_eat_chessman(string time,string s)
    {   
        //StartCoroutine(IEWriteToFile(name,time,s));
        StreamWriter sw = new StreamWriter( "Logfile2.txt" ,true);
        //StreamWriter sw = new StreamWriter( "C:/"+name+".txt" ,true);
        sw.WriteLine(time+": "+s);
        sw.Close();
    }
   
    public void WriteToFile_grid(string time,string s)
    {   
        //StartCoroutine(IEWriteToFile(name,time,s));
        StreamWriter sw = new StreamWriter( "Logfile3.txt" ,true);
        //StreamWriter sw = new StreamWriter( "C:/"+name+".txt" ,true);
        sw.WriteLine(time+": "+s);
        sw.Close();
    }
